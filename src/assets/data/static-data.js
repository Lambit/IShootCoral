...
export const GALLERY = [
    ...
    new Gallery('902-g', require('../images/gallery/YETI-3.jpeg'),),
    new Gallery('903-g', require('../images/gallery/JJ-6p.jpeg'), ),
    ...
    new Gallery('907-g', require('../images/gallery/Angel-eyes-7.jpeg'), ),
    new Gallery('908-g', require('../images/gallery/Full-tilt.jpeg'), ),
    new Gallery('909-g', require('../images/gallery/Cpt-Am-3p.jpeg'), ),
    new Gallery('910-g', require('../images/gallery/YETI-2.jpeg'), ),
    new Gallery('911-g', require('../images/gallery/OM-2p.jpeg'), ),
